document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        const response = await fetch('http://localhost:3000/gestion.ventas.html', {
            method: 'GET',
            headers: {
...
async function submitSale() {
    // Ejecutar la validación ANTES de intentar registrar la venta
...
function validarFormulario() {
    ...
    const documentoIdentidad = document.getElementById('document').value;
